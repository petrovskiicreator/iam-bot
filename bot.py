...
HELP_TEXT = (
    ...
    "Утренний ритуал: читай цели → пиши «Сегодня я...» (одна фраза о том, кем становишься). "
    "Вечерний ритуал: «Сегодня я...» → чек-ин. "
    "В разделе «Записать» доступны расширенные форматы: "
    "Визуализация (3 года вперёд от первого лица) и Благодарность (одна конкретная вещь прямо сейчас).\n\n"
    "<b>🔥 Цепочка дней</b>\n"
